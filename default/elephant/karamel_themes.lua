--
-- Dynamic Karamel Theme Menu for Elephant/Walker
--
Name = "karamelthemes"
NamePretty = "Karamel Themes"

-- The main function elephant will call
function GetEntries()
  local entries = {}
  local theme_dir = os.getenv("HOME") .. "/.config/karamel/themes"
    ...
    if theme_name then
      ...
      if preview_path and preview_path ~= "" then
        ...
        table.insert(entries, {
          ...
          PreviewType = "file",
          Actions = {
            activate = "karamel-theme-set " .. theme_name,
          },
        })
      end
    end
