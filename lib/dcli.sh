#!/usr/bin/env bash
# dcli integration functions for karamel installer
...
If you install dcli, this installer will automatically:
  ...
  • Add all karamel packages to your dcli host.yaml
...
# Create dcli host.yaml with all karamel packages
...
# Generated by karamel installer
# https://gitlab.com/theblackdon/karamel
...
setup_dcli() {
    ...
    echo ""
    log_info "dcli has been configured with all karamel packages"
